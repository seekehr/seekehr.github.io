...
export function ContactScreen() {
  ...
  const handleDiscordClick = () => {
    window.open("https://discord.gg/bHEjbQdEcx", "_blank")
  }
    ...
    <>
      <div className="fade-in">
        <div className="grid grid-cols-4 gap-4">
          ...
          >
            <div className="w-14 h-14 app-icon bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center overflow-hidden transition-transform group-active:scale-90">
              <DiscordLogo className="w-8 h-8 text-white drop-shadow-sm" />
            </div>
          ...
          <div
            ...
            className="flex flex-col items-center group cursor-pointer"
          >
            <div className="w-14 h-14 app-icon bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center overflow-hidden transition-transform group-active:scale-90">
